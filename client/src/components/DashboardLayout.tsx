...
const menuItems = [
  ...
  { icon: BarChart3, label: "Glucose", path: "/dashboard/glucose" },
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-4">
            <div className="w-16 h-16 rounded-full bg-primary flex items-center justify-center">
              <span className="text-primary-foreground font-bold text-2xl" style={{ fontFamily: "'Playfair Display', serif" }}>G</span>
            </div>
            <h1 className="text-2xl font-bold text-primary text-center" style={{ fontFamily: "'Playfair Display', serif" }}>
              Welcome to GluMira™
            </h1>
          ...
          <Button
            ...
            size="lg"
            className="w-full glum-btn-primary"
          >
            Sign in to continue
          </Button>
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed ? (
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="font-bold text-primary tracking-tight truncate text-sm" style={{ fontFamily: "'Playfair Display', serif" }}>
                    GluMira™
                  </span>
                </div>
              ) : null}
