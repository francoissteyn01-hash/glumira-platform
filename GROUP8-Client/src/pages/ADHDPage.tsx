  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      ...
      <footer className="text-center text-xs text-gray-500 dark:text-gray-400 pt-4">
        <p><strong>Disclaimer:</strong> GluMira™ is an educational platform and educational platform. The information provided is for educational purposes only and should not be used as a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified health provider with any questions you may have regarding a medical condition.</p>
