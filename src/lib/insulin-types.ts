/**
 * GluMira™ V7 — Insulin & IOB type definitions
 * Shared types for insulin profiles, doses, decay curves, and alerts.
 */
...
export interface InsulinProfile {
  ...
  decay_parameters: any; // JSONB object per model
  is_active: boolean;
  created_at: string;
}
...
export interface InsulinDose {
  ...
  insulin_name: string;
  dose_units: number;
  administered_at: string; // ISO string
