...
export default function SensorConfidenceCard({ readingsCount, expectedCount }: Props) {
  ...
  return (
    <div style={{ background: "#ffffff", borderRadius: 12, border: "1px solid #dee2e6", padding: 20 }}>
      <p style={{ margin: 0, fontSize: 12, fontWeight: 600, color: "#52667a", textTransform: "uppercase", letterSpacing: 0.5, fontFamily: "'DM Sans', system-ui, sans-serif" }}>Data Completeness</p>
      <p style={{ margin: "4px 0 0", fontSize: 32, fontWeight: 700, color: colour, fontFamily: "'JetBrains Mono', monospace" }}>{pct}%</p>
      <p style={{ margin: "2px 0 0", fontSize: 11, color: "#94a3b8", fontFamily: "'DM Sans', system-ui, sans-serif" }}>{readingsCount} of {expectedCount} expected readings</p>
    </div>
  );
}
