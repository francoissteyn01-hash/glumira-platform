  ...
  if (bullets.length === 0) {
    return (
      <div style={{ background: "#ffffff", borderRadius: 12, border: "1px solid #dee2e6", padding: 20 }}>
        <h3 style={{ margin: "0 0 8px", fontSize: 16, fontWeight: 700, color: "#1a2a5e", fontFamily: "'Playfair Display', serif" }}>
          Daily Summary
        </h3>
        <p style={{ fontSize: 13, color: "#52667a", margin: 0, fontFamily: "'DM Sans', system-ui, sans-serif" }}>
  ...
  return (
    <div style={{ background: "#ffffff", borderRadius: 12, border: "1px solid #dee2e6", padding: 20 }}>
      ...
      <ul style={{ margin: 0, paddingLeft: 18, display: "flex", flexDirection: "column", gap: 8 }}>
        {bullets.map((b, i) => (
          <li key={i} style={{ fontSize: 13, color: "#1a2a5e", lineHeight: 1.5, fontFamily: "'DM Sans', system-ui, sans-serif" }}>
            {b}
          </li>
        ))}
      </ul>
