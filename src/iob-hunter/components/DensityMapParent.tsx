/**
 * GluMira™ V7 — DensityMapParent
 *
 * Parent-audience view of the IOB peak collision map.
 ...
 *   – Suggestions derived from detected risk zones.
 *
...
export type DensityMapParentProps = {
...
function suggestions(curves: PerDoseActivityCurve[], hz: DensityRiskZone | null): string[] {
  ...
  // Find insulins active at peak collision
...
export default function DensityMapParent({
  curves,
  riskZones,
  startHour,
  endHour,
