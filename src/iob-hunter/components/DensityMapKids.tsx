        ...
        <div style={{ padding: "0", background: "#f8faff", overflowX: "auto" }}>
          ...
          >
            ...
            {/* Curve traces — solid strokes only, NO fill, so overlapping
                regions preserve each insulin's identity (no colour mixing). */}
            {[...curves]
              .sort((a, b) =>
              ...
              .map((c, i) => {
                ...
                return (
                  <path
                    ...
                    fill="none"
                    stroke={col}
                    strokeWidth={c.dose_type === "basal_injection" ? 2.5 : 3}
                    strokeLinejoin="round"
                    strokeLinecap="round"
                    strokeDasharray={c.dose_type === "basal_injection" ? "3 4" : undefined}
                    strokeOpacity={1}
                  />
                );
              })}
