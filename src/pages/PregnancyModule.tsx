    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-primary)", padding: "24px" }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "16px 0 24px" }}>
          ...
          <div>
            <h1 style={{ margin: 0, fontFamily: "'Playfair Display', serif", color: "var(--text-primary)", fontSize: 28 }}>Pregnancy Glucose Assessment</h1>
            <p style={{ margin: 0, color: "var(--text-muted)", fontSize: 14 }}>Educational trimester-specific glucose targets and risk analysis</p>
          </div>
        </div>

        {/* Input Form */}
        <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)", borderRadius: 16, padding: 24, marginBottom: 20 }}>
          <h2 style={{ color: "var(--text-primary)", fontSize: 18, marginBottom: 16 }}>Patient Information</h2>
          ...
          <button type="button" onClick={handleAssess} style={{ marginTop: 20, padding: "10px 28px", background: "var(--accent-teal)", color: "#fff", border: "none", borderRadius: 8, fontSize: 15, fontWeight: 600, cursor: "pointer" }}>
        ...
        {result && (
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={cardStyle}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
                ...
                <div style={statBox}>
                  ...
                  <div style={{ fontSize: 13, color: "var(--text-primary)" }}>{result.a1cStatus ?? "Not provided"}</div>
                </div>
              </div>
            </div>
            ...
            <div style={{ ...cardStyle, background: "#e8f4fd", borderColor: "#2ab5c1" }}>
              ...
              <p style={{ fontSize: 14, color: "var(--text-primary)", lineHeight: 1.6 }}>{result.trimesterGuidance}</p>
            </div>
            ...
            {result.warnings.length > 0 && (
              <div style={{ ...cardStyle, background: "var(--error-bg)", borderColor: "#fca5a5" }}>
          ...
          {[
            ...
            <div key={item.id} style={{ marginBottom: 8 }}>
              <button type="button"
                ...
                style={{ width: "100%", textAlign: "left", padding: "12px 16px", background: openTrimesterMeal === item.id ? "#e0f7f9" : "var(--bg-primary)", border: "1px solid var(--border)", borderRadius: 8, cursor: "pointer", fontSize: 14, fontWeight: 600, color: "var(--text-primary)", display: "flex", justifyContent: "space-between", alignItems: "center" }}
              >
                {item.title}
        ...
        <div style={{ ...cardStyle, marginTop: 16 }}>
          ...
          >
            ...
            <span style={{ fontSize: 18, color: "var(--text-primary)", transform: showPreeclampsia ? "rotate(180deg)" : "rotate(0deg)", transition: "transform 0.2s" }}>&#9662;</span>
          </button>
          {showPreeclampsia && (
            <div style={{ fontSize: 13, color: "#4a5568", lineHeight: 1.8, marginTop: 12 }}>
              ...
              <div style={{ padding: 10, background: "var(--error-bg)", borderRadius: 8, border: "1px solid var(--error-border)", marginTop: 8 }}>
        ...
        <div style={{ ...cardStyle, marginTop: 16 }}>
          ...
          >
            ...
            <span style={{ fontSize: 18, color: "var(--text-primary)", transform: showPostpartum ? "rotate(180deg)" : "rotate(0deg)", transition: "transform 0.2s" }}>&#9662;</span>
          </button>
          {showPostpartum && (
            <div style={{ fontSize: 13, color: "#4a5568", lineHeight: 1.8, marginTop: 12 }}>
        ...
        <div style={{ ...cardStyle, marginTop: 16 }}>
          ...
          >
            ...
            <span style={{ fontSize: 18, color: "var(--text-primary)", transform: showBreastfeedingCalc ? "rotate(180deg)" : "rotate(0deg)", transition: "transform 0.2s" }}>&#9662;</span>
          </button>
            ...
            <div style={{ fontSize: 13, color: "#4a5568", lineHeight: 1.8, marginTop: 12 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 12 }}>
                <div style={{ ...statBox, background: "#e8f4fd" }}>
                  ...
                  <div style={{ fontSize: 22, fontWeight: 700, color: "var(--text-primary)", fontFamily: "'JetBrains Mono', monospace" }}>+50-60g/day</div>
                  <div style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 4 }}>Spread across meals and snacks</div>
                </div>
                <div style={{ ...statBox, background: "#f0fdf4" }}>
                  ...
                  <div style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 4 }}>Reduce bolus doses by approximately 20%</div>
                </div>
              </div>
...
const pillStyle: React.CSSProperties = { padding: "4px 12px", border: "1px solid #d1d5db", borderRadius: 20, fontSize: 12, background: "var(--bg-card)", cursor: "pointer" };
const pillActive: React.CSSProperties = { background: "var(--accent-teal)", color: "#fff", borderColor: "#2ab5c1" };
