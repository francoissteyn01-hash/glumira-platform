...
const DEFAULT_DOSES: EditableDose[] = [
  { id: "b0", insulin: "Degludec (Tresiba)", dose: 12, hour: 18.5, type: "basal" },
  { id: "r0", insulin: "Fiasp", dose: 3, hour: 7, type: "bolus" },
  { id: "r1", insulin: "Fiasp", dose: 2.5, hour: 12.5, type: "bolus" },
  { id: "r2", insulin: "Humulin R", dose: 3.5, hour: 18, type: "bolus" },
];

export default function WhatIfPage() {
  const initialDoses = DEFAULT_DOSES;
