...
export const EDUCATION_TOPICS: EducationTopic[] = [
  ...
  // GROUP K: AUTISM + TYPE 1 DIABETES (101-110)
  { id: 101, group: "K", groupTitle: "Autism + Type 1 Diabetes", groupDescription: "Managing T1D when the world feels different — sensory support, executive function tools, and understanding for autistic individuals and their families", title: "Autism + T1D — why the combination needs its own playbook", ageRange: "all", audience: "all", status: "available" },
  { id: 102, group: "K", groupTitle: "Autism + Type 1 Diabetes", groupDescription: "Managing T1D when the world feels different — sensory support, executive function tools, and understanding for autistic individuals and their families", title: "Sensory profiles and blood glucose — finding treatments that don't overwhelm", ageRange: "all", audience: "all", status: "available" },
  { id: 103, group: "K", groupTitle: "Autism + Type 1 Diabetes", groupDescription: "Managing T1D when the world feels different — sensory support, executive function tools, and understanding for autistic individuals and their families", title: "Injection site tolerance — working with texture, pain, and predictability", ageRange: "all", audience: "all", status: "available" },
  { id: 104, group: "K", groupTitle: "Autism + Type 1 Diabetes", groupDescription: "Managing T1D when the world feels different — sensory support, executive function tools, and understanding for autistic individuals and their families", title: "Food aversions and hypo treatment — building a safe-food toolkit", ageRange: "all", audience: "all", status: "available" },
  { id: 105, group: "K", groupTitle: "Autism + Type 1 Diabetes", groupDescription: "Managing T1D when the world feels different — sensory support, executive function tools, and understanding for autistic individuals and their families", title: "Meltdown vs hypoglycaemia — how to tell the difference", ageRange: "all", audience: "all", status: "available" },
  { id: 106, group: "K", groupTitle: "Autism + Type 1 Diabetes", groupDescription: "Managing T1D when the world feels different — sensory support, executive function tools, and understanding for autistic individuals and their families", title: "Visual schedules for diabetes routines — predictability as care", ageRange: "all", audience: "all", status: "available" },
  { id: 107, group: "K", groupTitle: "Autism + Type 1 Diabetes", groupDescription: "Managing T1D when the world feels different — sensory support, executive function tools, and understanding for autistic individuals and their families", title: "Executive function and T1D self-management — scaffolding without shame", ageRange: "all", audience: "all", status: "available" },
  { id: 108, group: "K", groupTitle: "Autism + Type 1 Diabetes", groupDescription: "Managing T1D when the world feels different — sensory support, executive function tools, and understanding for autistic individuals and their families", title: "Autistic burnout and glucose control — recognising the warning signs", ageRange: "all", audience: "all", status: "available" },
  { id: 109, group: "K", groupTitle: "Autism + Type 1 Diabetes", groupDescription: "Managing T1D when the world feels different — sensory support, executive function tools, and understanding for autistic individuals and their families", title: "Communicating with the care team — scripts and accommodations to request", ageRange: "all", audience: "all", status: "available" },
  { id: 110, group: "K", groupTitle: "Autism + Type 1 Diabetes", groupDescription: "Managing T1D when the world feels different — sensory support, executive function tools, and understanding for autistic individuals and their families", title: "For parents and caregivers — supporting an autistic child with T1D", ageRange: "all", audience: "parent", status: "available" },
];
