/**
 * GluMira™ V7 — Demo Profiles for Safe Mode
 * Fictional data. No real patients.
 */
...
export const DEMO_PROFILES: DemoProfile[] = [
  {
    ...
    role: "caregiver",
    description: "Parent of a newly diagnosed toddler. Levemir 2x daily + Fiasp with meals. Frequent overnight lows.",
    avatar: "parent",
    child: {
      age: 3, weight: 14, diabetesType: "T1D", diagnosedMonths: 4,
      regimen: [
  ...
  },
  {
    ...
    role: "caregiver",
    description: "Parent of school-age child. Tresiba once daily + NovoRapid with meals. Managing school days and sports.",
    avatar: "parent",
    child: {
      age: 8, weight: 28, diabetesType: "T1D", diagnosedMonths: 36,
      regimen: [
  ...
  },
  {
    ...
    name: "Aisha (Age 15)",
    role: "patient",
    description: "Teen managing independently. Tresiba + Fiasp. Navigating school exams, sport, and social life.",
    avatar: "teen",
    child: {
      age: 15, weight: 55, diabetesType: "T1D", diagnosedMonths: 72,
      regimen: [
  ...
  },
  {
    ...
    name: "Marcus (Age 34)",
    role: "patient",
    description: "Adult self-managing with Bernstein low-carb approach. Lantus + Actrapid. Focused on tight control.",
    avatar: "adult",
    child: {
      age: 34, weight: 82, diabetesType: "T1D", diagnosedMonths: 240,
      regimen: [
  ...
  },
  {
    ...
    role: "clinician",
    description: "Paediatric endocrinologist reviewing 3 patient profiles. Report generation and pattern analysis.",
    avatar: "clinician",
    patients: [
