...
GluMira™ is an educational education tool designed to make the science of insulin visible, powered by the IOB Hunter™ engine. The platform is currently in Phase 1 (Beta Testing) and transitioning into Phase 2 (Clinician Assistant). 
